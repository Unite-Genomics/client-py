    ...
    def get_capability(self, force=False):
        ...
        if self._capability is None or force:
            ...
            settings = {
                ...
                'client_id': self.client.client_id if self.client is not None else None,
                'private_key': self.client.private_key if self.client is not None else None,
                'public_key': self.client.public_key if self.client is not None else None,
            }
